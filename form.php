  ...
  <div class="container">
    ...
    <form action="" method="POST">
      ...
      <div class="form-group">
        <input type="dates" id="dates" size="3" name="dates" <?php if ($errors['dates']) {print 'class="group error"';} else print 'class="group"';?> value="<?php print $values['dates']; ?>">
      </div>
      ...
      <select class="group" name="languages[]" size="10" multiple>
        ...
        <option value="Cplusplus" <?php if (in_array("C++", $values['languages'])) {print 'selected';} ?>>C++</option>
